...
> 
> **Dependencies Added**: The project uses `html2canvas` to capture and download the periodic table as an image dynamically. Running `yarn install` will automatically install this dependency.
